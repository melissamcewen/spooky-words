...
app.get('/all-predicates/', (req,res)=>{
...
// endpoint for just a bunch of words, used for the halloween name generator
app.get('/words/', (req,res)=>{
  const words =  [...friendlyWords.predicates, ...friendlyWords.objects];
  res.json(words);
});
